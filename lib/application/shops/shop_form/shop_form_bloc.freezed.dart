...
/// @nodoc
abstract class $ShopChangedCopyWith<$Res> {
  factory $ShopChangedCopyWith(
          ShopChanged value, $Res Function(ShopChanged) then) =
      _$ShopChangedCopyWithImpl<$Res>;
  $Res call({Shop shop});
...
/// @nodoc
class _$ShopChangedCopyWithImpl<$Res> extends _$ShopFormEventCopyWithImpl<$Res>
    implements $ShopChangedCopyWith<$Res> {
  _$ShopChangedCopyWithImpl(
      ShopChanged _value, $Res Function(ShopChanged) _then)
      : super(_value, (v) => _then(v as ShopChanged));

  @override
  ShopChanged get _value => super._value as ShopChanged;

  @override
  $Res call({
    Object shop = freezed,
  }) {
    return _then(ShopChanged(
...
/// @nodoc
class _$ShopChanged implements ShopChanged {
  const _$ShopChanged(this.shop) : assert(shop != null);
  ...
  @override
  String toString() {
    return 'ShopFormEvent.shopChanged(shop: $shop)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is ShopChanged &&
...
abstract class ShopChanged implements ShopFormEvent {
